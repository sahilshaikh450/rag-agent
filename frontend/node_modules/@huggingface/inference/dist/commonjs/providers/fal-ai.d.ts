...
declare abstract class FalAiQueueTask extends FalAITask {
    ...
    makeRoute(params: UrlParams): string;
    getResponseFromQueueApi(response: FalAiQueueOutput, url?: string, headers?: Record<string, string>, signal?: AbortSignal): Promise<unknown>;
}
export declare class FalAITextToImageTask extends FalAiQueueTask implements TextToImageTaskHelper {
    task: InferenceTask;
    constructor();
    preparePayload(params: BodyParams): Record<string, unknown>;
    getResponse(response: FalAiQueueOutput, url?: string, headers?: Record<string, string>, outputType?: OutputType, signal?: AbortSignal): Promise<string | Blob | Record<string, unknown>>;
}
export declare class FalAIImageToImageTask extends FalAiQueueTask implements ImageToImageTaskHelper {
    ...
    getResponse(response: FalAiQueueOutput, url?: string, headers?: Record<string, string>, _outputType?: undefined, signal?: AbortSignal): Promise<Blob>;
}
...
export declare class FalAITextToSpeechTask extends FalAITask {
    preparePayload(params: BodyParams): Record<string, unknown>;
    getResponse(response: unknown, _url?: string, _headers?: HeadersInit, _outputType?: undefined, signal?: AbortSignal): Promise<Blob>;
}
export declare class FalAIImageSegmentationTask extends FalAiQueueTask implements ImageSegmentationTaskHelper {
    ...
    getResponse(response: FalAiQueueOutput, url?: string, headers?: Record<string, string>, _outputType?: undefined, signal?: AbortSignal): Promise<ImageSegmentationOutput>;
}
export {};

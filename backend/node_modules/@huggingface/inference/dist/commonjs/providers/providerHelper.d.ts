...
export declare abstract class TaskProviderHelper {
     ...
     */
    abstract getResponse(response: unknown, url?: string, headers?: HeadersInit, outputType?: OutputType, signal?: AbortSignal): Promise<unknown>;
    /**
...
export interface TextToImageTaskHelper {
    getResponse(response: unknown, url?: string, headers?: HeadersInit, outputType?: OutputType, signal?: AbortSignal): Promise<string | Blob | Record<string, unknown>>;
    preparePayload(params: BodyParams<TextToImageInput & BaseArgs>): Record<string, unknown>;
}
export interface TextToVideoTaskHelper {
    getResponse(response: unknown, url?: string, headers?: Record<string, string>, outputType?: undefined, signal?: AbortSignal): Promise<Blob>;
    preparePayload(params: BodyParams<TextToVideoInput & BaseArgs>): Record<string, unknown>;
}
export interface ImageToImageTaskHelper {
    getResponse(response: unknown, url?: string, headers?: HeadersInit, outputType?: undefined, signal?: AbortSignal): Promise<Blob>;
...
export interface ImageSegmentationTaskHelper {
    getResponse(response: unknown, url?: string, headers?: HeadersInit, outputType?: undefined, signal?: AbortSignal): Promise<ImageSegmentationOutput>;
...
export interface AutomaticSpeechRecognitionTaskHelper {
    getResponse(response: unknown, url?: string, headers?: HeadersInit, outputType?: undefined, signal?: AbortSignal): Promise<AutomaticSpeechRecognitionOutput>;
...
export declare class AutoRouterConversationalTask extends BaseConversationalTask {
    constructor();
    makeBaseUrl(params: UrlParams): string;
}
